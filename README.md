# Aptlantis Core Standards Library
...
`D:\.library\aptlantis_core` is the canonical active standards library for the Aptlantis development drive.
...
For standards incubation, historical comparison, or promotion review, use `D:\.city_hall` after reading the active library record first.
...
| `PPS` | Project Proposal Standard | Project intent, boundaries, constraints, risks, success, failure, and roadmap framing. |
...
Use this library when the question is, "What governs active work now?"

Use City Hall when the question is, "How did this standard develop, what is still experimental, or what should be promoted next?"
...
4. active standards under this library
5. verified current source, tests, artifacts, and evidence
6. City Hall-only drafts, references, and preserved planning material

...
3. `D:\.library\aptlantis_core\README.md` and the relevant active standard suite when the task concerns active governance, or when the root manifest is absent and must be recovered.

...
Active standards library: `D:\.library\aptlantis_core`
...
- `D:\.library\aptlantis_core` is the active standards library and the home for solid/adopted governance material.
...
Under the current authority model, the active read path begins with `D:\Development.manifest.toml`, `D:\AGENTS.md`, `D:\INDEX.md`, and `D:\.library\aptlantis_core`.
...
`D:\.library\aptlantis_core\City Hall Operational Case Study.pdf`
...
- `D:\.library\aptlantis_core\README.md` and `D:\.library\aptlantis_core\WORKSHOP-MAP.md` are the active overview entry points.
